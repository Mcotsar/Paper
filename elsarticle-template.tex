...
The patterns observed in the first 2 Principal Components were plotted to visualize the degree of isolation among workshops. The results, shown in Fig., suggested than amphorae from closer workshops tend to be more similar than amphorae made in furthest workshops. In particular, the Fig illustrates how the four closest workshops show variation on PC1 (i.e. Belén, Delicias, Villaseca and Malpica) while Parlamento display a distinctive pattern than the rest of workshops on PC2 values. 
